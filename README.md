...
- Web: [Link for site]( Link for site)
- Telegram: [Link for site](link for Telegram)
- Mail: [admin mail]( admin mail)
- GitHub: [GitHub repo](GitHub repo)
- Discord: [https://discord.gg/GBhbEP](https://discord.gg/GBhbEP)

## Compiling the BitMoney V2 GUI from source

### On Linux:

(Tested on Ubuntu 17.10 x64, Ubuntu 18.04 x64 and Gentoo x64)

1. Install Bitmoney V2 dependencies
...
3. Install [BitMoney V2](GITHUB LINK) dependencies:
...
6. Grab an up-to-date copy of the BitMonet V2 repository
...
The Bitmoney V2 GUI on Windows is 64 bits only; 32-bit Windows GUI builds are not officially supported anymore.
